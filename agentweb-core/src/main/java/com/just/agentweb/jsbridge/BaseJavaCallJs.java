 ...
 * @since 1.0.0
 */
public abstract class BaseJavaCallJs implements JavaCallJs {

    private WebView mWebView;
    public static final String TAG=BaseJavaCallJs.class.getSimpleName();
    BaseJavaCallJs(WebView webView){
